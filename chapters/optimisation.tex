...
\felipe{Plot a q function: its theoretical value and sample approximations using a finite set of datapoints}
...
\begin{mdframed}[style=ejemplo, frametitle={\center Example: different optimisers}]
	...
	\felipe{If possible, show different optimisers in a toy example}
